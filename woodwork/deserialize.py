    ...
    **kwargs,
    ...
    Args:
        ...
        filename (str, optional): The name of the file used to store the data during serialization. If not specified, will be
            determined from the typing info file. Must be specified when deserializing from a parquet file.
        ...
        format (str, optional): The format used to serialize the data. Required if the serialized filename suffix does not clearly
            indicate the format.
